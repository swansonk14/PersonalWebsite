  ...
  render() {
    return (
      <div className="Page">
        ...
        <p>Currently in my PhD, I have continued to develop machine learning models for drug discovery. I built a generative model for synthesizable small molecule design named <a href="https://www.nature.com/articles/s42256-024-00809-7">SyntheMol</a>, which I applied to antibiotic discovery. I also continued my work on molecular property prediction, developing <a href="https://academic.oup.com/bioinformatics/article/40/7/btae416/7698030">ADMET-AI</a> to predict durglike properties of small molecules. More recently, I have been developing large language model agents for drug discovery in the form of the <a href="https://www.biorxiv.org/content/10.1101/2024.11.11.623004v1">Virtual Lab</a>, which I applied to nanobody design for recent variants of SARS-CoV-2.</p>
