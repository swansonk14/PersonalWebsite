  ...
  public render() {
    return (
      <div className="Page">
        ...
        <p>I am currently a master's student in biotechnology at Imperial College London as part of a two-year <a href="https://www.marshallscholarship.org/">Marshall Scholarship</a> in the United Kingdom. Previously, I completed an MASt in mathematical statistics at the University of Cambridge (Trinity College), and before that I was at the Massachusetts Institute of Technology, where I obtained a BS in Computer Science and Engineering (Course 6-3) and Mathematics (Course 18) and an MEng in Computer Science and Engineering, supervised by <a href="https://people.csail.mit.edu/regina/">Professor Regina Barzilay</a> in MIT's Computer Science and Artificial Intelligence Laboratory (CSAIL).</p>
