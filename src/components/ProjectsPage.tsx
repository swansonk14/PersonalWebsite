  ...
  public render() {
    return (
      <div className="Page">
        ...
        <img className="projectImage" src="images/tap.png" alt="Image of Tap"></img>
        <br></br>
        ...
        <img className="projectImage" src="images/nn.png" alt="Image of IntroML"></img>
        <br></br>
        ...
        <img className="projectImage" src="images/flea_adder.gif" alt="Image of Graphing Fleas"></img>
        <br></br>
