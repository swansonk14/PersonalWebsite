  ...
  render() {
    return (
      <div className="Page">
        ...
        <img className="projectImage" src="images/tap.png" alt="Tap"></img>
        <br></br>
        ...
        <p>The <a href="https://github.com/swansonk14/typed-argument-parser">code</a> is open-source and was developed by Jesse Michel and myself. As of March 2026, Tap has over <a href="https://pepy.tech/project/typed-argument-parser">10 million downloads</a>.</p>

        <Divider />

        <h2 className="projectTitle"><a href="https://github.com/swansonk14/IntroML"> IntroML</a></h2>
        <img className="projectImage" src="images/nn.png" alt="IntroML"></img>
        <br></br>
